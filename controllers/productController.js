...
const getAllProducts = catchAsyncErrors(async (req, res) => {
  const itemsPerPage = 8; // Number of products appearing on 1 page
...
// Get delete reviews of the product
const deleteProductsReviews = catchAsyncErrors(async (req, res, next) => {
  const product = await Product.findById(req.query.productId);
